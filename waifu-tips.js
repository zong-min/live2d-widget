...
function loadWidget(waifuPath, apiPath) {
	...
	sessionStorage.removeItem("waifu-text");
        // 添加 style="transform:scale(0.8);transform-origin:left bottom;"，让原本的 Live2D 大小变为 80%
	$("body").append(`<div id="waifu" style="transform:scale(0.8);transform-origin:left bottom;">
	...
	function registerEventListener() {
		...
		$("#waifu-tool .fa-info-circle").click(() => {
			open("https://www.cnblogs.com/zongmin/");
		});
	...
	function welcomeMessage() {
		var text;
		var SiteIndexUrl = 'https://www.cnblogs.com/zongmin/'; // 手动指定主页
